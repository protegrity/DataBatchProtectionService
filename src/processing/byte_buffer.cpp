...
ByteBuffer<Codec>::ByteBuffer(
    ...
    : num_elements_(num_elements),
      ...
      prefix_size_(prefix_size) {
    if constexpr (!is_fixed_sized) {
        throw InvalidInputException("ByteBuffer constructor for fixed-size elements only.");
    }
    element_size_ = codec_.element_size();
...
ByteBuffer<Codec>::ByteBuffer(
    ...
    : num_elements_(num_elements),
      ...
      prefix_size_(prefix_size) {
    if constexpr (is_fixed_sized) {
        throw InvalidInputException("ByteBuffer constructor for variable-size elements only.");
    }
...
// -----------------------------------------------------------------------------
// Codecs used by explicit template instantiations in this translation unit.
// -----------------------------------------------------------------------------
