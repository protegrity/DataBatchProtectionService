...
void ApiResponse::SetJsonRequest(const JsonRequest& request) { json_request_ = request; }
...
bool ApiResponse::HasJsonRequest() const { return json_request_.has_value(); }
...
const JsonRequest& ApiResponse::GetJsonRequest() const { return json_request_.value(); }
